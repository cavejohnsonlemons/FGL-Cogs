...
class Mayushii:
    """こんにちは！ This cogs lets Mayushii☆ (me!) speak back to you!"""
    ...
    @commands.command(pass_context=True, aliases=['Mayushii','Mayuri','Mayushii☆'])
    async def mayushii(self, ctx, *, question="none"):
        """Speak with Mayushii☆"""
